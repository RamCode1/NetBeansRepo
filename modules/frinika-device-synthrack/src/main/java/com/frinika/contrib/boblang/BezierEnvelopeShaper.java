...
public class BezierEnvelopeShaper {
    ...
    private static final int MAX_AMPLITUDE = BezierParamsV3_5.MAX_AMPLITUDE,
    ...
    private static final int RELEASE_EXTRA = 48000;			// Needed to give a full buffer of zeroes

    // Envelope shaping attributes
    private int attackTime, // Time in mS for attack after note start
    ...
    private double sustainLevel, // Sustain level as fraction of max amplitude
    ...
    /**
     * Constructor which converts envelope data in the Ant Params object into
     * their equivalent attributes. In practice, it calls the public method
     * reshapeEnvelope () to allow dynamic envelope changes
     */
     ...
     * attributes. This method may be used to dynamically change the envelope,
     ...
     * position in the sound wave. The position is obtained from index and this
     * version of the method assumes that the note has not been released.
     *
     * <p>
     * If window is non-zero, then the factor is the average value for a window
     * of samples starting at index and of the specified width
     */
    ...
    /**
     * Get the multiplication factor for the current sample based on its
     * position in the sound wave but assuming it was released at the specified
     * time.
     */
