...
public class BezierSynthPlayer extends Thread {
    ...
    private static final int NOTE_ON = CommandList.NOTE_ON,
            NOTE_OFF = CommandList.NOTE_OFF;

    // Other constants
    private static final int SAMPLES_PER_CYCLE = 128, // Number of samples written
    ...
    // Java write buffer
    private int writeBufferLength;							// Length of line write buffer

    // Links to other objects
    private SourceDataLine line;                       // Output sound device
    private BezierEnvelopeShaper shaper;                     // Envelope shaper
    private BezierParams params;                     // Copy of synth parameters
    private CommandList commands;                   // Circular buffer of note on/off commands
    ...
    public BezierSynthPlayer(BezierParams inParams,
        ...
        try {
            ...
            AudioFormat format = new AudioFormat((float) params.getOutputRate(), 16, 1, true, false);
