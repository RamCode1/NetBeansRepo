...
/**
 * <p>
 * An abstract class which will have concrete extensions to accept midi input
 * and format the commands into an active buffer.
 *
 * <p>
 * This class is abstract so that the various extensions can use different input
 * techniques, such as Pure Java for windows and apple.com for Max OS X.
 *
 * @author Bob Lang
 * @version 23 Mar 2003
 */
